  ...
  return (
    <StepOneContainer>
      <div className="step-one-container">
        ...
        <h5 className="step-one-heading">Step One</h5>
        {/* </p> */}

        <h1 className="post-heading">Post compliant requests in minutes</h1>
        <p className="step-one-need">
          Tell us what you need and Response uses your terms to generate all the
          necessary paperwork.
        </p>
      </div>
      <div className="step-one-request">
        <img
          className="step-one-request-image"
